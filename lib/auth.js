...
export async function authenticateGitHub() {
  ...
  // GitHub Apps don't use scope — permissions are set in the app settings
...
async function exchangeCode(provider, code, codeVerifier, redirectUri, customTokenUrl) {
  ...
  // GitLab requires grant_type (standard OAuth2), GitHub does not
  if (provider !== 'github') {
    body.set('grant_type', 'authorization_code');
  }

  // GitHub Apps: include client_secret if one was generated
