...
export async function authenticateGitHub(isRetry = false) {
  ...
  // Verificar que el token tenga los scopes necesarios (especialmente 'repo' para repos privados).
  // Si GitHub cacheo una autorización antigua con scopes insuficientes, el token no tendrá 'repo'.
  ...
  if (!scopes.includes('repo') && !isRetry) {
